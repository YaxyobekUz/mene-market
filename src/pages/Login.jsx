...
const Login = () => {
    ...
    return (
        <div className="flex-center justify-center grow container p-0 max-w-[1480px] h-full">
            <div className="grid grid-cols-2 h-screen max-768:grid-cols-1">
                {/* img wrapper */}
                <div
                ...
                <div className="flex px-20 py-8 h-screen overflow-y-auto max-1024:px-14 max-860:p-10 max-768:h-auto max-768:overflow-y-visible max-450:px-5">
                    <div className='max-w-[456px] w-full my-auto'>
                        {/* title */}
                        <h1 className="mb-6">Sign up</h1>
                        <p className="text-regular-16 text-primary-gray-500 mb-8">Already have an account? <Link to='/register' className='text-primary-blue-700 mb-8'>Sign in</Link></p>
                        ...
                        <form className="login-form">
                            ...
                            <label className="login-form_privacy-policy-wrapper">
                                <input
                                    type="checkbox"
                                    ...
                                    required
                                />
                                <span className='login-form_privacy-policy-wrapper_text'>
                            ...
                            <button className="login-form_submit-btn">Sign Up</button>
                        </form>
                    </div>
                </div>
            </div>
