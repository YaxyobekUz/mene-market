...
const ProductDetail = () => {
  ...
  const [productCount, setProductCount] = useState(
    numberOfProductsAvailable > 0 ? 1 : 0
  );
  ...
  if (productData) {
    useEffect(() => {
      const elInfoTabBtn = tabsButtonsRef.current.querySelector(
        ".js-button__product-info-tab"
      );
      const elReviewTabBtn = tabsButtonsRef.current.querySelector(
        ".js-button__product-reviews-tab"
      );
      ...
      const updateLinePosition = () => {
        if (showReviews) {
          ...
          elLine.style.transform = `translateX(${
            rect.left - tabsButtonsRef.current.getBoundingClientRect().left
          }px)`;
        } else {
        ...
        <div className="container">
          <div className="grid grid-cols-2 gap-6 mb-12 max-768:grid-cols-1">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <h1 className="text-[29px] font-semibold leading-8 max-490:text-semibold-23">
                  {productData.name}
                </h1>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex-center gap-2.5">
                  <div className="main-btn relative p-2 w-24 max-w-full border-primary-black-800">
                    ...
                    <span className="flex-center justify-center w-2 left-[calc(50%-4px)] absolute">
                      {productCount}
                    </span>
                    <button
                  ...
                  {numberOfProductsAvailable !== 0 ? (
                    <span className="text-regular-13 text-secondary-green-500">
                      Sotuvda {numberOfProductsAvailable}ta bor
                    </span>
                  ) : (
                    <span className="text-regular-13 text-primary-red-500">
                      Hozircha ushbu mahsulotdan qolmadi
                    </span>
                  )}
                </div>
              </div>
              ...
              >
                ...
                {/* body */}
                <p className="text-regular-13 text-primary-black-800">
                  Yetkazib berish summasi manzilingizga ko'ra 20,000 so'mdan
                  boshlanadi. Agar 2 ta mahsulot xarid qilsangiz yetkazib berish
                  bepul. (Bonusli mahsulotlar bundan mustasno)
                </p>
              </div>
          ...
          <div>
            ...
            <div ref={tabsButtonsRef} className="flex relative gap-6 pb-1 mb-6">
              ...
              {/* active line */}
              <div
                className={`js-line w-[136px] absolute h-0.5 bg-linear-gradient_blue-500 bottom-0 transition-all duration-300`}
              ></div>
            </div>
            ...
            <div className={`${showReviews ? "block" : "hidden"} space-y-6`}>
                  ...
                  return (
                    <li key={index} className="reviews-list_item">
                      ...
                      <img
                        ...
                        src={stars}
                        alt="stars image"
                        className="reviews-list_item_img"
                      />
                      {/* title */}
                      <h3 className="reviews-list_item_title">Samantha D.</h3>
                      {/* description */}
                      <p className="reviews-list_item_description">
                        {reviewText}
                      </p>
                      {/* date */}
                      <span className="reviews-list_item_date">
                        August 14, 2023
                      </span>
                    </li>
                  );
              ...
              <button className="main-btn text-regular-16">
                Ko'proq ko'rsatish
              </button>
            </div>
          </div>
