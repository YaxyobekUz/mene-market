  ...
  return (
    <div>
      ...
      <ul className="space-y-6">
        ...
        <li className="flex gap-6 bg-linear-gradient_black-800 backdrop-filter backdrop-blur-120 rounded-20 p-6 max-768:flex-col max-450:p-5 max-450:gap-5 max-375:p-4">
          <img
            width={440}
            height={248}
          ...
          <div>
            ...
            <p className="text-primary-gray-500 mb-2 max-375:text-base">
