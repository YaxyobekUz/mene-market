    ...
    <div className="w-full space-y-6">
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="bg-jellyfish py-8 px-6 bg-cover bg-center rounded-20 bg-primary-black-800">
          <div className="space-y-2.5">
            {/* image */}
            <img src={profile} alt="Yaxyobek Xabibullayev" className="w-16 h-16 rounded-full bg-primary-gray-500" />
            <h1 className="text-white text-bold-28 font-semibold ">Yaxyobek Xabibullayev</h1>
            <p className="text-regular-14 text-primary-gray-500">Xush kelibsiz!</p>
          </div>
        </div>
          ...
          <div className="flex-center justify-between">
            <ul className='space-y-4'>
              <li className="bg-linear-gradient_black-800 max-w-[210px] w-full px-6 py-5 space-y-1.5 rounded-20">
                <h3 className="text-regular-14 text-primary-gray-500">Sotib olganlar</h3>
                <p className="text-white">145 kishi</p>
              </li>
              <li className="bg-linear-gradient_black-800 max-w-[210px] w-full px-6 py-5 space-y-1.5 rounded-20">
                <h3 className="text-regular-14 text-primary-gray-500">Havola orqali kirganlar</h3>
      ...
      <section className="p-6 rounded-20 bg-linear-gradient_black-800">
        ...
        <div className="flex-center-between mb-6">
          ...
          <Link to='/admin/news' className='text-regular-13'>Barchasini ko'rsatish</Link>
        </div>
        ...
        <ul className="dashboard_news">
          <li className="dashboard_news_item">
            ...
            <p className="dashboard_news_item_description">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minima expedita dicta, dolores doloribus qui, nemo labore culpa commodi totam harum, adipisci omnis. At ducimus provident totam, architecto non autem ratione!</p>
          </li>
          <li className="dashboard_news_item">
            <h3 className="dashboard_news_item_title">Yangilik nomi</h3>
            <p className="dashboard_news_item_description">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minima expedita dicta, dolores doloribus qui, nemo labore culpa commodi totam harum, adipisci omnis. At ducimus provident totam, architecto non autem ratione!</p>
