            ...
            <div className="flex flex-col justify-between w-52 h-full">
                ...
                <div className='flex flex-col h-full'>
                    ...
                    <Link to="/" className='flex-center flex-col'>
                        <img src={logo} width={96} height={48} alt="logo image" className="w-24 h-12 mb-4" />
                    </Link>
                        ...
                        <ul className="navigation space-y-2">
                            ...
                            <li className="navigation_item">
                                <NavLink className="navigation_item_link" to='/admin/market'>
                                    <span className="navigation_item_link_icon-wrapper">
                                        <img src={market} width={20} height={20} alt="market icon image" className="navigation_item_link_icon" />
                                    </span>
                            ...
                            <li className="navigation_item">
                                <NavLink className="navigation_item_link" to='/admin/flow'>
                                    <span className="navigation_item_link_icon-wrapper">
                                        <img src={link} width={20} height={20} alt="link icon image" className="navigation_item_link_icon" />
                                    </span>
                            ...
                            <li className="navigation_item">
                                <NavLink className="navigation_item_link" to='/admin/statistics'>
                                    <span className="navigation_item_link_icon-wrapper">
                                        <img src={statistics} width={20} height={20} alt="statistics icon image" className="navigation_item_link_icon" />
                                    </span>
                            ...
                            <li className="navigation_item">
                                <NavLink className="navigation_item_link" to='/admin/payment'>
                                    <span className="navigation_item_link_icon-wrapper">
                                        <img src={wallet} width={20} height={20} alt="wallet icon image" className="navigation_item_link_icon" />
                                    </span>
                            ...
                            <li className="navigation_item">
                                <NavLink className="navigation_item_link" to='/admin/profile'>
                                    <span className="navigation_item_link_icon-wrapper">
                                        <img src={profile} width={20} height={20} alt="profile icon image" className="navigation_item_link_icon" />
                                    </span>
                    ...
                    {/* log out */}
                    <button className="navigation_item_link">
                        <span className="navigation_item_link_icon-wrapper">
                            <img src={logout} width={20} height={20} alt="logout icon image" className="navigation_item_link_icon" />
                        </span>
