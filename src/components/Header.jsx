                    ...
                    <li key={index}>
                      <Link
                        to={`/product/${product.name
                          .toLowerCase()
                          .replace(/\s+/g, "-")}`}
                        className="search-results_list_item"
                      >
                        <img
                          src={product.images[0].src}
                          alt=""
                          className="search-results_list_item_img"
                        />
                        <h3 className="search-results_list_item_title">
                          {product.name}
                        </h3>
                      </Link>
                    </li>
          ...
          <div className="flex-center space-x-6 max-540:space-x-5 max-375:space-x-4">
            ...
            <div className="flex-center space-x-1">
              ...
              <img
                ...
                src={arrowDownIcon}
                alt="user icon"
                className="w-4 h-4 max-450:hidden"
              />
            </div>
            ...
            {isLoggedIn ? (
              <Link to="/admin/dashboard" className="flex-center space-x-1">
                <img
                  ...
                  className="w-6 h-6"
                />
                <span className="max-450:hidden">Profile</span>
              </Link>
            ) : (
